...
<tileset version="1.5" tiledversion="1.7.0" name="YokaAnimatedArrows2" tilewidth="33" tileheight="24" tilecount="16" columns="8" objectalignment="top">
 <image source="YokaAnimatedArrows2.png" width="264" height="48"/>
 <tile id="0">
  <animation>
