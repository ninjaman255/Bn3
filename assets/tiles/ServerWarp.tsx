...
<tileset version="1.5" tiledversion="1.7.0" name="ServerWarp" tilewidth="58" tileheight="30" tilecount="10" columns="5" objectalignment="top">
 <tileoffset x="0" y="2"/>
 <image source="ServerWarp.png" trans="ffffff" width="290" height="60"/>
 <tile id="0">
  <objectgroup draworder="index" id="2">
   <object id="5" x="11" y="13">
    <polygon points="0,0 18,-10 36,0 18,10"/>
   </object>
  </objectgroup>
  <animation>
